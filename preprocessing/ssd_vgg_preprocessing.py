...
def distorted_bounding_box_crop(image,
    ...
    Args:
        ...
        bboxes: 3-D float Tensor of bounding boxes arranged [1, num_boxes, coords]
...
def preprocess_for_train(image, shape, labels, bboxes,
                         out_shape, data_format='NHWC',
                         scope='ssd_preprocessing_train'):
    """Preprocesses the given image for training.
    Args:
        image: A `Tensor` representing an image of arbitrary size.
        labels: The labels of objects in this image.
        bboxes:
        out_shape: The shape of the image after preprocessing.
        data_format:
        scope:
    Returns:
...
def preprocess_image(image,
    ...
    Args:
        image: A `Tensor` representing an image of arbitrary size.
        shape: The original shape of an image.
        labels:
        bboxes:
        out_shape: The output shape of the image after preprocessing.
    ...
    """
    if is_training:
        return preprocess_for_train(image, shape, labels, bboxes,
                                    out_shape=out_shape,
