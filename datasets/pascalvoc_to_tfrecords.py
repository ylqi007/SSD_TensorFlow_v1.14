...
from datasets.dataset_utils import float_feature
...
def _process_image(directory, name):
    ...
    Args:
        directory: string, path to an image file e.g., '/path/JPEGImages/example.JPG'.
...
def run(dataset_dir, output_dir, name='voc_train', shuffling=False):
    ...
    Args:
        ...
        name: prefix name for output tfrecord files.
        shuffling: shuffle or not.
    """
